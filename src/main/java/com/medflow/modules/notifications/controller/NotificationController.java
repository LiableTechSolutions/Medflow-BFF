...
class NotificationController {
  ...
  ApiResponse<PageResponse<NotificationResponse>> list(
    ...
    return ApiResponse.success("Notifications retrieved successfully",
        service.list(unreadOnly, page, size));
  }
  ...
  ApiResponse<Map<String, Long>> unreadCount() {
    return ApiResponse.success("Unread count retrieved successfully",
        Map.of("unread", service.unreadCount()));
  }
  ...
  ApiResponse<NotificationResponse> markRead(@PathVariable UUID notificationId) {
    return ApiResponse.success("Notification marked as read", service.markRead(notificationId));
  }
  ...
  ApiResponse<Map<String, Integer>> markAllRead() {
    return ApiResponse.success("All notifications marked as read",
        Map.of("updated", service.markAllRead()));
  }
}
